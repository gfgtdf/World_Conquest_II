...
local supply_images = 
{
	...
	"misc/blank-hex.png~BLIT(items/straw-bale1.png~CROP(8,15,64,57))~BLIT(items/leather-pack.png~CROP(0,10,62,62),10,0)~BLIT(items/leather-pack.png~CROP(0,0,69,72),3,0)~MASK(misc/wct-blank.png)~BLIT(terrain/wct-supply2.png)",
	-- hidden image to replace custom
	"misc/blank-hex.png~BLIT(items/straw-bale2.png~CROP(19,18,53,54))~BLIT(items/straw-bale2.png~CROP(7,6,65,66))~BLIT(items/leather-pack.png~CROP(4,23,68,49))~BLIT(items/straw-bale2.png~CROP(7,15,65,57))~MASK(misc/wct-blank.png)~BLIT(terrain/wct-supply1.png)",
	...
	-- hidden image to replace custom
	"misc/blank-hex.png~BLIT(items/box.png~SCALE(54,54)~CROP(0,11,54,43),4,0)~MASK(misc/wct-blank.png)~BLIT(terrain/wct-supply3.png)~BLIT(items/box.png~SCALE(54,54)~CROP(0,1,54,53),17,0)",
}
