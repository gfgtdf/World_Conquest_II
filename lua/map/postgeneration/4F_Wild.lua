local Postgeneration4FWild = {}

function Postgeneration4FWild:impl(map)
...
function Postgeneration4FWild:repaint()
	local heights = wesnoth.dofile("./4F_Wild_zones")
