...
function wct_roads_to_river_industry(radius)
...
function wct_roads_to_factory(radius)
	return get_locations(f.all(
		f.terrain("!,W*^*,*^V*,*^Bcx*,Urb,C*,K*^*,R*"),
		f.adjacent(f.all(
			f.terrain("*^Vhh,Rr"),
...
function wct_roads_to_industrial_city(radius)
	return get_locations(f.all(
		f.terrain("!,W*^*,*^V*,*^Bcx*,Urb,C*,K*^*,R*"),
		f.adjacent(f.all(
			f.terrain("*^Vhc,Rrc"),
...
function wct_roads_to_industrial_village(radius)
	return get_locations(f.all(
		f.terrain("!,W*^*,*^V*,*^Bcx*,Urb,C*,K*^*,R*"),
		f.adjacent(f.all(
			f.terrain("*^Ve,*^Vl,Rb"),
...
function wct_rails_to_industrial_keep(radius)
	return get_locations(f.all(
		f.terrain("C*"),
		f.adjacent(f.all(
			f.terrain("*^Br*,*^Vhh"),
